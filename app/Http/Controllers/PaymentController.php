...
public function stripeCharge(Request $request)
{
    ...
    // Set your secret key: remember to change this to your live secret key in production
		...
		\Stripe\Stripe::setApiKey('sk_test_51JLtNmGQ9YOHizojwqyyxpLTXn82XLnwTLwSUxqRMUYqr9rjKKTXBXwVftYkXAK1EMxXbr6VA5VN7jfaRcBjxhHr003hsaWHfX');
...
return view('admin.order.return_order',compact('order'));
