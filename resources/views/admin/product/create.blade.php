            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_size" id="size" data-role="tagsinput" placeholder="Enter Size">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <label class="custom-file">
                      <input type="file" id="file" class="custom-file-input" name="image_one" onchange="readURL1(this);" requried="" >
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <label class="custom-file">
                      <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL2(this);" requried="">
                      <span class="custom-file-control"></span>
                      <img src="#" id='two'>
                 </label>    
                </div>
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <label class="custom-file">
                      <input type="file" id="file" class="custom-file-input" name="image_three" onchange="readURL3(this);" requried="">
                      <span class="custom-file-control"></span>
                      <img src="#" id='three'>
                 </label>    
                </div>
