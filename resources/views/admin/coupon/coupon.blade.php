            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Coupons Code</th>
                  <th class="wd-15p">Coupons Persentage</th>
          ...
          <div class="modal-dialog modal-lg" role="document">
            ...
            @endif
              ...
              <div class="modal-body pd-20">   
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Coupon Discount" name="discount">
                </div>
              </div><!-- modal-body -->
